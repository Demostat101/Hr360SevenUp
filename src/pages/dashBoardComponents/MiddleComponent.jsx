...
const MiddleComponent = () => {
  ...
  const [graph, setGraph] = useState(false);
    ...
    const {open} = Context()
  return (
    <main className={open ? "2xl:w-[1127px] 2xl:flex-nowrap md:flex-wrap 2xl:h-[290.71px] flex 2xl:gap-[30px] md:w-[100%] md:h-[250px] md:gap-[30px] md:justify-center" : "2xl:w-[1240.9px] 2xl:h-[325.59px] flex 2xl:gap-[33.03px] md:w-[100%] 2xl:flex-nowrap md:flex-wrap md:h-[280px] md:gap-[40px] md:justify-center"}>
      ...
      {/* Graph container / left side container */}
        ...
        <div className={open ? "2xl:w-[358px] bg-[#FFFFFF] rounded-lg shadow-lg 2xl:h-[295.71px] md:w-[300px] md:h-[100%]" : "2xl:w-[394.18px] bg-[#FFFFFF] 2xl:h-[325.59px] rounded-lg md:w-[330px] shadow-lg md:h-[100%]"}>
          <DashCalender/>
        </div>
