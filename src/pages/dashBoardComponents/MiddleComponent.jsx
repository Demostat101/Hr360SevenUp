...
const MiddleComponent = () => {
  ...
  const [graph, setGraph] = useState(false);
    ...
    const {open} = Context()
  return (
    <main className={open ? "2xl:w-[1127px] 2xl:flex-nowrap md:flex-wrap 2xl:h-[290.71px] flex 2xl:gap-[30px] md:w-[100%] md:h-[250px] md:justify-between" : "2xl:w-[1240.9px] 2xl:h-[325.59px] flex 2xl:gap-[33.03px] md:w-[100%] 2xl:flex-nowrap md:flex-wrap md:h-[280px] md:justify-between"}>

      {/* Graph container / left side container */}
        <div className={open ? "2xl:w-[739px] flex flex-col shadow-lg rounded-lg bg-[#FFFFFF] gap-[15px] 2xl:h-[295px] md:w-[628px] md:h-[250px]" : "2xl:w-[813.69px] shadow-lg rounded-lg bg-[#FFFFFF] gap-[17px] flex flex-col 2xl:h-[324.81px] md:w-[685px] md:h-[275px]"} >
          ...
          <div className={open ? "2xl:w-[698px] 2xl:h-[42px] 2xl:gap-[154px] flex place-items-center md:w-[100%] md:h-[30px] md:justify-between" : "2xl:w-[768.67px] 2xl:h-[45.82px] 2xl:gap-[169.56px] flex place-items-center md:w-[95%] md:h-[30px] md:justify-between"}>
            {/* graph top content */}
            <div className={open ? "2xl:w-[256px] pl-[15px] 2xl:h-[24px] 2xl:text-[16px] 2xl:leading-[24px] font-[500] md:w-[20%] md:h-[100%] md:text-[12px] md:leading-[18px] md:text-nowrap" : "2xl:w-[282px] 2xl:h-[26px] 2xl:text-[17.62px] 2xl:leading-[26.43px] pl-[15px] font-[500] md:w-[30%] md:h-[100%] md:text-nowrap md:text-[14px] md:leading-[20px]"} >Employee Availability Overview</div>
        ...
        <div className={open ? "2xl:w-[358px] bg-[#FFFFFF] rounded-lg shadow-lg 2xl:h-[295.71px] md:w-[320px] md:h-[100%]" : "2xl:w-[394.18px] bg-[#FFFFFF] 2xl:h-[325.59px] rounded-lg md:w-[370px] shadow-lg md:h-[100%]"}>
          <DashCalender/>
        </div>
