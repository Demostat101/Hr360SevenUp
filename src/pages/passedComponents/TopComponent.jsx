...
const TopComponent = () => {
    const {open} = Context();
  return (
    <div className={open ? "w-full 2xl:h-[228.01px] md:h-full border-solid flex justify-between border-2 border-red-600" : "w-full 2xl:h-[251.06px] md:h-full border-solid flex justify-between border-2 border-yellow-600"}>
        {/* container holding all cards */}
       {
        EmployeeStore.map(({img, total, employee, update}, index)=>{
               ...
               <div className={open ? "2xl:w-[78.85px] bg-white absolute top-[-25px] left-5 2xl:h-[64.99px] md:w-[70px] md:h-[60px] box" :"2xl:w-[86.81px] bg-white absolute top-[-25px] left-5 2xl:h-[71.56px] md:w-[75px] md:h-[65px] box"}>
                 ...
                 <div className={open ? "2xl:w-[193.92px] 2xl:h-[116.14px] flex flex-col justify-evenly md:w-[190px] md:h-[110px]" : "2xl:w-[213.51px] 2xl:h-[127.87px] flex flex-col justify-evenly md:w-[210px] md:h-[121px]"}>
                   ...
                   <div className={open ? "2xl:w-[150px] flex flex-col gap-[5px] 2xl:h-[57px] md:w-[145px] md:h-[50px]" : "2xl:w-[165px] 2xl:h-[63px] md:w-[160px] md:h-[60px] flex flex-col gap-[5px]"}>
                     <span className={open ? "2xl:text-[20px] 2xl:leading[30px] 2xl:font-[600] md:text-[15px] md:leading-[25px] md:font-[500]" : "2xl:text-[22.02px] 2xl:leading[33.03px] 2xl:font-[600] md:text-[18px] md:leading-[30px] md:font-[500]"}>{total}</span>
                     <span className={open ? "2xl:text-[18px] 2xl:leading[27px] 2xl:font-[400] md:text-[10px] md:leading-[20px] md:font-[400]" : "2xl:text-[19.82px] 2xl:leading[29.73px] 2xl:font-[400] md:text-[15px] md:leading-[25px] md:font-[400]"}>{employee}</span>
                   </div>

                   {/* paragraph text under employee and figure */}

                   <p className={open ? "2xl:text-[12px] 2xl:leading[18px] 2xl:font-[400] text-nowrap md:text-[8px] md:leading-[10px] md:font-[400] text-[#969696]" : "2xl:text-[13.21px] 2xl:leading[19.82px] 2xl:font-[400] 2xl:text-nowrap md:text-[8px] md:leading-[12px] md:font-[400] text-[#969696]"}>{update}</p>
