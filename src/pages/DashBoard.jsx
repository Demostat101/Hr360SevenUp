  ...
  return (
    <main className='w-full flex flex-col place-items-center'>
      <div className={open ? "2xl:w-[1128px] md:w-[95%] 2xl:h-[978.82px] md:max-h-[978.82px] 2xl:pt-[20px] " : "2xl:w-[1242px] md:w-[95%] md:max-h-[1077.8px] 2xl:h-[1077.8px] 2xl:pt-[5px] " }>
        ...
        <div className={open ? "w-[100%] 2xl:h-[914.82px] md:h-full mt-[50px] flex flex-col 2xl:gap-[25px] md:gap-[15px] border-solid border-2 border-red-800" : "w-[100%] 2xl:h-[1007.28px] md:h-full mt-[50px] flex flex-col 2xl:gap-[27.53px] md:gap-[18px] border-solid border-2 border-yellow-800"}>
          <TopComponent/>
          <MiddleComponent/>
        </div>
