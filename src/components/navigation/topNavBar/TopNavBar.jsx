...
const TopNavBar = () => {
  ...
  return (
    <>
      <header className={ !open ? "2xl:w-[1312px] max-w-[1312px] bg-[#FFFFFF] h-[86px] flex flex-col justify-center place-items-center" :"2xl:w-[1190px] max-w-[1190px] bg-[#FFFFFF] h-[78px] flex flex-col justify-center place-items-center"  } >
