  ...
  return (
    <>
      <header
        className={
          !open
            ? "2xl:w-[1312px] max-w-[1312px] bg-[#FFFFFF] border-r h-[86px] flex flex-col justify-center place-items-center"
            : "2xl:w-[1190px] border-r max-w-[1190px] bg-[#FFFFFF] h-[78px] flex flex-col justify-center place-items-center"
        }
      >
        <div
          className={
            open
              ? "2xl:w-[1128.52px] md:w-[95%] bg-[#FFFFFF] h-[58px] flex justify-between place-items-center"
              : "2xl:w-[1242.32px] bg-[#FFFFFF] md:w-[95%] h-[63.85px] flex justify-between place-items-center"
          }
        >
